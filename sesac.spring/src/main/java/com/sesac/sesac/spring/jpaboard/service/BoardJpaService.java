package com.sesac.sesac.spring.jpaboard.service;

import com.sesac.sesac.spring.jpa.repository.StudentRepository;
import com.sesac.sesac.spring.jpaboard.domain.Board;
import com.sesac.sesac.spring.jpaboard.dto.BoardDTO;
import com.sesac.sesac.spring.jpaboard.entity.BoardEntity;
import com.sesac.sesac.spring.jpaboard.mapper.BoardJpaMapper;
import com.sesac.sesac.spring.jpaboard.repository.BoardRepository;
...
//        List<Board> result = boardMapper.getBoardAll();
        ...
        for ( BoardEntity boardEntity : jpaResult ) {
            ...
            // 1) dto의 값을 timestamp로 변경
            // 2) timestamp를 -> string으로 파싱 << 채택 - (SimpleDateFormat)
